...
!function(e, r) {
    ...
    function e(t) {
        this.mode = m.MODE_8BIT_BYTE, this.data = t;
    }
    function r(t, e) {
    ...
    var a = Object.prototype.hasOwnProperty, u = Object.prototype.toString, s = Object.defineProperty, h = Object.getOwnPropertyDescriptor, l = function(t) {
        return "function" == typeof Array.isArray ? Array.isArray(t) : "[object Array]" === u.call(t);
    }, f = function(t) {
        if (!t || "[object Object]" !== u.call(t)) return !1;
        var e, r = a.call(t, "constructor"), o = t.constructor && t.constructor.prototype && a.call(t.constructor.prototype, "isPrototypeOf");
        ...
        if ("__proto__" === e) {
            if (!a.call(t, e)) return;
            if (h) return h(t, e).value;
        }
        return t[e];
    }, d = function e() {
        var r, o, n, i, a, u, s = arguments[0], h = 1, d = arguments.length, m = !1;
        for ("boolean" == typeof s && (m = s, s = arguments[1] || {}, h = 2), (null == s || "object" != (void 0 === s ? "undefined" : t(s)) && "function" != typeof s) && (s = {}); h < d; ++h) if (null != (r = arguments[h])) for (o in r) n = c(s, o), 
        s !== (i = c(r, o)) && (m && i && (f(i) || (a = l(i))) ? (a ? (a = !1, u = n && l(n) ? n : []) : u = n && f(n) ? n : {}, 
        g(s, {
            name: o,
            newValue: e(m, u, i)
        })) : void 0 !== i && g(s, {
    ...
    e.prototype = {
            ...
            if (this.typeNumber < 1) {
                ...
                for (t = 1; t < 40; t++) {
                    ...
                    for (a = 0; a < this.dataList.length; a++) {
                        ...
                        r.put(u.mode, 4), r.put(u.getLength(), v.getLengthInBits(u.mode, t)), u.write(r);
                    }
        ...
        setupTypeInfo: function(t, e) {
            for (var r = this.errorCorrectLevel << 3 | e, o = v.getBCHTypeInfo(r), n = 0; n < 15; n++) {
                var i = !t && 1 == (o >> n & 1);
        ...
        mapData: function(t, e) {
            for (var r = -1, o = this.moduleCount - 1, n = 7, i = 0, a = this.moduleCount - 1; a > 0; a -= 2) for (6 == a && a--; ;) {
                for (var u = 0; u < 2; u++) if (null == this.modules[o][a - u]) {
                    var s = !1;
                    i < t.length && (s = 1 == (t[i] >>> n & 1)), v.getMask(e, o, a - u) && (s = !s), 
        ...
        for (var a = n.getRSBlocks(t, e), u = new i(), s = 0; s < o.length; s++) {
            var h = o[s];
            u.put(h.mode, 4), u.put(h.getLength(), v.getLengthInBits(h.mode, t)), h.write(u);
        }
        var l = 0;
        for (s = 0; s < a.length; s++) l += a[s].dataCount;
        ...
        for (;!(u.getLengthInBits() >= 8 * l || (u.put(r.PAD0, 8), u.getLengthInBits() >= 8 * l)); ) u.put(r.PAD1, 8);
        ...
        for (var r = 0, n = 0, i = 0, a = new Array(e.length), u = new Array(e.length), s = 0; s < e.length; s++) {
            ...
            n = Math.max(n, h), i = Math.max(i, l), a[s] = new Array(h);
            for (var f = 0; f < a[s].length; f++) a[s][f] = 255 & t.buffer[f + r];
            r += h;
            var g = v.getErrorCorrectPolynomial(l), c = new o(a[s], g.getLength() - 1).mod(g);
            for (u[s] = new Array(g.getLength() - 1), f = 0; f < u[s].length; f++) {
                var d = f + c.getLength() - u[s].length;
                u[s][f] = d >= 0 ? c.get(d) : 0;
            }
        }
        var m = 0;
        ...
        for (f = 0; f < n; f++) for (s = 0; s < e.length; s++) f < a[s].length && (p[C++] = a[s][f]);
        for (f = 0; f < i; f++) for (s = 0; s < e.length; s++) f < u[s].length && (p[C++] = u[s][f]);
        return p;
    };
    for (var m = {
        MODE_NUMBER: 1,
        ...
        getErrorCorrectPolynomial: function(t) {
            for (var e = new o([ 1 ], 0), r = 0; r < t; r++) e = e.multiply(new o([ 1, C.gexp(r) ], 0));
            return e;
        },
    ...
    }, y = 0; y < 8; y++) C.EXP_TABLE[y] = 1 << y;
    for (y = 8; y < 256; y++) C.EXP_TABLE[y] = C.EXP_TABLE[y - 4] ^ C.EXP_TABLE[y - 5] ^ C.EXP_TABLE[y - 6] ^ C.EXP_TABLE[y - 8];
    for (y = 0; y < 255; y++) C.LOG_TABLE[C.EXP_TABLE[y]] = y;
    return o.prototype = {
        get: function(t) {
            return this.num[t];
        },
    ...
    n.getRSBlocks = function(t, e) {
        ...
        for (var o = r.length / 3, i = new Array(), a = 0; a < o; a++) for (var u = r[3 * a + 0], s = r[3 * a + 1], h = r[3 * a + 2], l = 0; l < u; l++) i.push(new n(s, h));
        return i;
        ...
        t = t || {}, (t = d(!0, {
            ...
            var e, o = new r(t.typeNumber, t.correctLevel);
            o.addData(function(t) {
                var e, r, o, n;
                ...
                return e;
            }(t.text)), o.make(), e = t.ctx ? t.ctx : t._this ? wx.createCanvasContext && wx.createCanvasContext(t.canvasId, t._this) : wx.createCanvasContext && wx.createCanvasContext(t.canvasId);
            for (var n = t.width / o.getModuleCount(), i = t.height / o.getModuleCount(), a = 0; a < o.getModuleCount(); a++) for (var u = 0; u < o.getModuleCount(); u++) {
                var s = o.isDark(a, u) ? t.foreground : t.background;
                e.setFillStyle(s);
                var h = Math.ceil((u + 1) * n) - Math.floor(u * n), l = Math.ceil((a + 1) * n) - Math.floor(a * n);
                e.fillRect(Math.round(u * n) + t.x, Math.round(a * i) + t.y, h, l);
            }
